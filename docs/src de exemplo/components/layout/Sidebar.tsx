            ...
            <>
              ...
              >
                <div className="w-[180px] flex flex-col whitespace-nowrap">
                  <h1 className='text-2xl font-bold text-primary-foreground leading-tight font-playfair mb-1'>
                    Singaerj
                  </h1>
                  <span className='text-sm text-primary-foreground leading-tight'>Respeito e Confiança</span>
                </div>
              </motion.div>
            </>
          )}
      ...
      <div className="flex-grow flex flex-col px-3 pt-4 space-y-3">
        {links.map((link, index) => {
          ...
          const colorScheme = {
            ...
            yellow: {
              gradient: '',
              border: 'border-[#EDEBB9]/60',
              hover: 'hover:bg-white/10',
              iconBg: 'bg-[#EDEBB9]/30',
              iconColor: 'text-[#EDEBB9]',
              textColor: 'text-[#EDEBB9]',
              subtextColor: 'text-[#EDEBB9]/90'
            }
          };
      ...
      >
        {collapsed ? (
          ...
          <div className="flex justify-center">
            <UserProfile showLoading={false} collapsed={true} />
          </div>
        ) : (
          // Modo expandido - componente completo
          <div className="w-full">
            <UserProfile showLoading={false} collapsed={false} />
          </div>
        )}
      </div>
    </motion.div>
